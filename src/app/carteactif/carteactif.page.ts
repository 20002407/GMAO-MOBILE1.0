...
@Component({
  selector: 'app-carteactif',
  templateUrl: './carteactif.page.html',
  styleUrls: ['./carteactif.page.scss'],
})
export class CarteactifPage implements OnInit {
  items: any[];
  map:  Map | undefined ;
  ...
  initializeMap() {
    ...
    this.addGeolocation();
    this.initPopup(); // Call initPopup() after adding geolocation
